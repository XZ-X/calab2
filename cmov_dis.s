...
08048330 <main>:
 ...
 8048340:	53                   	push   %ebx
 8048341:	51                   	push   %ecx
 8048342:	be 05 00 00 00       	mov    $0x5,%esi
 8048347:	31 c9                	xor    %ecx,%ecx
 8048349:	bb 07 00 00 00       	mov    $0x7,%ebx
 804834e:	83 ec 0c             	sub    $0xc,%esp
 8048351:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8048358:	89 da                	mov    %ebx,%edx
 804835a:	a9 01 00 00 00       	test   $0x1,%eax
 804835f:	0f 45 d6             	cmovne %esi,%edx
 8048362:	83 c0 01             	add    $0x1,%eax
 8048365:	01 d1                	add    %edx,%ecx
 8048367:	3d 00 e1 f5 05       	cmp    $0x5f5e100,%eax
 804836c:	75 ea                	jne    8048358 <main+0x28>
 804836e:	83 ec 04             	sub    $0x4,%esp
 8048371:	51                   	push   %ecx
 8048372:	68 00 85 04 08       	push   $0x8048500
 8048377:	6a 01                	push   $0x1
 8048379:	e8 92 ff ff ff       	call   8048310 <__printf_chk@plt>
 804837e:	83 c4 10             	add    $0x10,%esp
 8048381:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
0804838e <_start>:
 804838e:	31 ed                	xor    %ebp,%ebp
 8048390:	5e                   	pop    %esi
 8048391:	89 e1                	mov    %esp,%ecx
 8048393:	83 e4 f0             	and    $0xfffffff0,%esp
 8048396:	50                   	push   %eax
 8048397:	54                   	push   %esp
 8048398:	52                   	push   %edx
 8048399:	68 e0 84 04 08       	push   $0x80484e0
 804839e:	68 80 84 04 08       	push   $0x8048480
 80483a3:	51                   	push   %ecx
 80483a4:	56                   	push   %esi
 80483a5:	68 30 83 04 08       	push   $0x8048330
 80483aa:	e8 51 ff ff ff       	call   8048300 <__libc_start_main@plt>
 80483af:	f4                   	hlt    
